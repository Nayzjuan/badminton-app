    ...
    >
      ...
      {isFirst && (
        <span
          className={cn(
            barlowFont,
            "font-black italic absolute right-[-4px] top-[-12px]",
      ...
      <div
        className={cn(
          barlowFont,
          "font-black italic leading-[.82] tracking-tight",
          rankSize,
          rankColor
        )}
      ...
      <div
        className={cn(
          barlowFont,
          "font-bold dark:font-extrabold tracking-[.03em] uppercase truncate mt-1",
          "text-[#111827] dark:text-amber-50",
      ...
      {row.win_streak >= 3 && (
        <div
          className={cn(
            monoFont,
            "text-[10px] font-bold flex items-center gap-0.5 mt-1.5",
            "text-amber-600 dark:text-[hsl(38_92%_52%)]"
          )}
  ...
  return (
    <div className="px-4 pt-2.5 pb-4">
      ...
      <div
        className={cn(
          monoFont,
          "text-[9.5px] tracking-[.2em] font-bold uppercase",
      ...
      >
        ...
        {/* Amber gradient rule */}
        <span
          className="flex-1 h-px bg-gradient-to-r from-amber-500 to-transparent dark:from-[hsl(38_92%_52%)] dark:to-transparent"
          aria-hidden="true"
        />
